    ...
    return (
        <Canvas>
            <Row className='px-8 pt-14 pb-12'>
                <h1 className='text-4xl font-semibold tracking-tight text-foreground'>Crawl engine</h1>
                <p className='mt-3 text-[15px] text-muted'>Global fleet telemetry — operator view, streaming live.</p>
            </Row>
